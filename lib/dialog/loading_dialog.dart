...
class LoadingDialog extends Dialog {
  LoadingDialog({
    ...
    EdgeInsetsGeometry? padding,
        ...
        _padding = padding ?? const EdgeInsets.fromLTRB(20, 15, 20, 15),
        _color = color ?? Colors.white70,
        _textColor = textColor ?? Colors.black45,
        super(key: key);
  ...
  List<Widget> _buildWidget() {
    ...
    if (title != null && title!.isNotEmpty && title!.trim().isNotEmpty) {
...
// 点击Dialog外部关闭Dialog
        ...
        child: Container(
          padding: const EdgeInsets.all(20), // 外边距
